...
<div class="container">
    <div class="row">
        <div class="col-md-8 order-md-1">
            <h4 class="mb-3"></h4>
            <form name="uf" accept-charset="utf-8" id="uf" method="get" action="adminInsertTeacherSave" class="needs-validation" novalidate>
                <div class="mb-3">
                    <span>用 户 名：</span>
                    <label>
                        <input type="text" maxlength="20" readonly style="margin-top: 10px" name="no" value="${cno}">
                    </label>
                </div>
                <br/>
                <div class="mb-3">
